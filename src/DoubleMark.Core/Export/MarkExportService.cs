...
public sealed class MarkExportService
{
    ...
    public static string DefaultExportRoot =>
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "DoubleMark", "exports");

    public static string DefaultDiagnosticsRoot =>
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "DoubleMark", "diagnostics");
        ...
        string normalized)
    {
        ...
        try
        {
            ...
            var text = new StringBuilder()
                .AppendLine("DoubleMark invalid scan diagnostic")
        ...
        MarkingCode code)
    {
        ...
        sb.AppendLine("DoubleMark local export");
